        ...
        async function checkRanks(userData){
            ...
            for (let i = 0; i < userData.length; i++) {
                setTimeout(async function timer() {
                    try {
                        const rankId = await noblox.getRankInGroup(790907, Number(userData[i].childKey))
                        console.log(rankId)
                        if (rankId == 2 || rankId == 3 || rankId == 91 || rankId == 92 || rankId == 93 || rankId == 94 || rankId == 95 || rankId == 96 || rankId == 97) {
                            try {
                                if ((Number(userData[i].childData.xp) >= 1) && (Number(userData[i].childData.xp) < 5)){
                                    if (rankId !== 91) {
                                        noblox.setRank(790907, Number(userData[i].childKey), 91)
                                        console.log(`Set rank for ${userData[i].childKey}`)
                                    } else {
                                        console.log(`${userData[i].childKey} is alrready in the correct rank.`)
                                    }
                                }
                                if ((Number(userData[i].childData.xp) >= 5) && (Number(userData[i].childData.xp) < 10)){
                                    if (rankId !== 92) {
                                ...
                                if ((Number(userData[i].childData.xp) >= 10) && (Number(userData[i].childData.xp) < 25)){
                                    if (rankId !== 93) {
                                ...
                                if ((Number(userData[i].childData.xp) >= 25) && (Number(userData[i].childData.xp) < 50)){
                                    if (rankId !== 94) {
                                ...
                                if ((Number(userData[i].childData.xp) >= 50) && (Number(userData[i].childData.xp) < 75)){
                                    if (rankId !== 95) {
                                ...
                                if ((Number(userData[i].childData.xp) >= 75) && (Number(userData[i].childData.xp) < 100)){
                                    if (rankId !== 96) {
                                ...
                                console.log(`Error setting rank for ${userData[i].childKey}, data ${userData[i].childData.xp}`)
                            }
                        }
                    } catch {
